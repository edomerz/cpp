...
public:
	...
	:Animal(other), m_numLegs(other.m_numLegs)
	{
...
public:
  ...
  LegendaryAnimal(const LegendaryAnimal& other_):
	  m_a1(new Centipede(*static_cast<Centipede*>(other_.m_a1))),
	  m_a2(new Centipede(*static_cast<Centipede*>(other_.m_a2))),
	  m_c(other_.m_c),
	  m_sq(other_.m_sq)
  {}
...
int main(int argc, char **argv, char **envp)
{
	...
	Centipede arr3[4];			// 4 Centipede Ctor calls
